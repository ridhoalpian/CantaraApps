...
class DikirimAdapter (
    private val context: Context,
    private val dikirimList: List<RiwayatModel>,
    private val listener: DikirimListener
) : RecyclerView.Adapter<DikirimAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val currentKue = dikirimList[position]
