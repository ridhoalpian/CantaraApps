...
class DibuatAdapter (
    ...
    private val dibuatList: List<RiwayatModel>,
    private val listener: DibuatListener
) : RecyclerView.Adapter<DibuatAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val currentKue = dibuatList[position]
